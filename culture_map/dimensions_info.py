...
DIMENSIONS_INFO = {
    ...
    'idv': {
        ...
        'description':
            "This index explores the \"degree to which people in a society are " \
    ...
    'mas': {
        ...
        'description': 
            "In this dimension, masculinity is defined as \"a preference in " \
    ...
    'uai': {
        ...
        'description': 
            "The uncertainty avoidance index is defined as \"a society's tolerance " \
    ...
    'lto': {
        ...
        'description': 
            "This dimension associates the connection of the past with the " \
    ...
    'ind': {
        ...
        'description':
            "This dimension refers to the degree of freedom that societal norms give " \
