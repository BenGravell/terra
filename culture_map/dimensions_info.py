...
DIMENSIONS_INFO = {
    "pdi": {
        "name": "Power Distance",
        "abbreviation": "PDI",
        "question": "To which extent you accept that individuals in societies are not equal?",
        "description": "The power distance index is defined as "
    ...
    "idv": {
        "name": "Individualism",
        "abbreviation": "IDV",
        "question": "How independent you would like to be in your society?",
        "description": 'This index explores the "degree to which people in a society are '
    ...
    "mas": {
        "name": "Masculinity",
        "abbreviation": "MAS",
        "question": "How much are you driven by competition, achievement and success and able to sacrifice caring for others and quality of life?",
        "description": 'In this dimension, masculinity is defined as "a preference in '
    ...
    "uai": {
        ...
        "abbreviation": "UAI",
        "question": "To which extent you feel threatened by ambiguous or unknown situations and try to avoid them?",
        "description": "The uncertainty avoidance index is defined as \"a society's tolerance "
    ...
    "lto": {
        ...
        "abbreviation": "LTO",
        "question": "How much do you consider past when dealing with future and present challenges?",
        "description": "This dimension associates the connection of the past with current and future actions/challenges. "
        'A higher degree of this index (long-term) indicates that adaptation and circumstantial, pragmatic problem-solving are viewed as a necessity to be ready for the future, as the future is always changing. Long term oriented, or "flexhumble", societies have a dynamic mindset towards the future. Relationships are considered valuable to them, leading them to lean towards long term relationships. '
        'Societies with a low degree in this index (short-term) look to the past to solve the problems they face in the present and to make decisions for the future. Stability is important to these short term oriented, or "monumentalist", societies, leading them to stick to conventions and to maintain a rather static and fixed mindset. Respect to tradition is of utmost importance; therefore, they may plan and prepare less for the future. '
    ...
    "ind": {
        "name": "Indulgence",
        "abbreviation": "IND",
        "question": "To which extent you would like to express your desires and impulses?",
        "description": "This dimension refers to the degree of freedom that societal norms give "
