...
def diff_col(obj1, obj2, col1, col2, name1=None, name2=None):
...
diff_col("./data/country_coords.csv", "./data/country_codes_alpha_3.csv", "country", "country")
# # known_missing: TODO

diff_col(country_urls_df, "./data/country_codes_alpha_3.csv", "country", "country", name1="country_urls_df")
# known missing: South Ossetia, Vatican City

diff_col(culture_fit_df, "./data/country_codes_alpha_3.csv", "country", "country", name1="culture_fit_df")
# known missing: None

diff_col("./data/happy_planet_index_2019.csv", "./data/country_codes_alpha_3.csv", "Country", "country")
# known missing: None

diff_col("./data/social_progress_index_2022.csv", "./data/country_codes_alpha_3.csv", "Country", "country")
# known missing: West Bank and Gaza

diff_col("./data/human-freedom-index-2022.csv", "./data/country_codes_alpha_3.csv", "country", "country")
# known missing: None

diff_col("./data/english_speaking.csv", "./data/country_codes_alpha_3.csv", "country", "country")
# known missing: None


# Checks from source-to-source (sequential)

diff_col(culture_fit_df, "./data/happy_planet_index_2019.csv", "country", "Country", name1="culture_fit_df")
# known missing: Angola, Cape Verde, Fiji, Puerto Rico, Sao Tome and Principe, Suriname, Syria

diff_col("./data/happy_planet_index_2019.csv", "./data/social_progress_index_2022.csv", "Country", "Country")
# known missing: Hong Kong, Palestine, Taiwan, Vanuatu

diff_col("./data/social_progress_index_2022.csv", "./data/human-freedom-index-2022.csv", "Country", "country")
...
diff_col("./data/human-freedom-index-2022.csv", "./data/english_speaking.csv", "country", "country")
# known missing: a lot...
